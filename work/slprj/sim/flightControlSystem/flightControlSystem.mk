...
MODULES                 = edgecanny_autoth_r_rt.c rc_gaussian_smoothing_r_rt.c r_derivative_image_r_rt.c c_derivative_image_r_rt.c nonmaximum_suppression_r_rt.c hough_d_rt.c hough_r_rt.c flightControlSystem.c flightControlSystem_capi.c flightControlSystem_data.c
...
{$(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge}.c.obj :
...
edgecanny_autoth_r_rt.obj : $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\edgecanny_autoth_r_rt.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\edgecanny_autoth_r_rt.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\edgecanny_autoth_r_rt.c

rc_gaussian_smoothing_r_rt.obj : $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\rc_gaussian_smoothing_r_rt.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\rc_gaussian_smoothing_r_rt.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\rc_gaussian_smoothing_r_rt.c

r_derivative_image_r_rt.obj : $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\r_derivative_image_r_rt.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\r_derivative_image_r_rt.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\r_derivative_image_r_rt.c

c_derivative_image_r_rt.obj : $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\c_derivative_image_r_rt.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\c_derivative_image_r_rt.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\c_derivative_image_r_rt.c

nonmaximum_suppression_r_rt.obj : $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\nonmaximum_suppression_r_rt.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\nonmaximum_suppression_r_rt.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge\nonmaximum_suppression_r_rt.c

hough_d_rt.obj : $(MATLAB_ROOT)\toolbox\vision\visionrt\viphough\hough_d_rt.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\toolbox\vision\visionrt\viphough\hough_d_rt.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\toolbox\vision\visionrt\viphough\hough_d_rt.c

hough_r_rt.obj : $(MATLAB_ROOT)\toolbox\vision\visionrt\viphough\hough_r_rt.c
	@cmd /C "echo ### Compiling $(MATLAB_ROOT)\toolbox\vision\visionrt\viphough\hough_r_rt.c
	$(CC) $(CFLAGS) $(MATLAB_ROOT)\toolbox\vision\visionrt\viphough\hough_r_rt.c



{$(MATLAB_ROOT)\toolbox\vision\visionrt\vipedge}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(CPPFLAGS) $<
